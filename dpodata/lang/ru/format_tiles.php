...
/**
 * Strings for component 'format_tiles', language 'ru', branch 'MOODLE_36_STABLE'
 *
...
$string['browsersessionstorage'] = 'Хранилище сессии в браузере (хранит контент курса)';
$string['changecourseicon'] = 'Щелкните, чтобы выбрать новый значок';
...
$string['coloursettings'] = 'Настройки цвета';
...
$string['dataprefquestion'] = '<p>Чтобы упростить использование этого сайта, мы храним в браузере такую функциональную информацию как контент последней плитки, которую Вы открывали. Он остается на вашем компьютере в течение короткого времени на случай, если Вы снова посетите эту страницу. Мы не используем этот контент для отслеживания. Вы не против?</p><p>Мы запомним ваш выбор до тех пор, пока Вы не очистите свою историю в браузере. Ответ «Нет» может привести к более медленной загрузке страницы.</p>';
...
$string['pickicon'] = 'Выбрать новый значок';
...
$string['tooltipchangeicon'] = 'Щелкните, чтобы изменить значок';
