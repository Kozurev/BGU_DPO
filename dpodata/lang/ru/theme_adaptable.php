...
/**
 * Strings for component 'theme_adaptable', language 'ru', branch 'MOODLE_36_STABLE'
 *
...
$string['alertannouncedesc'] = 'Показать объявление в окне предупреждения';
...
$string['alertcount'] = 'Количество окон предупреждений';
...
$string['blockheaderbordertopstyle'] = 'Стиль границы заголовка блока';
$string['blockheaderbordertopstyledesc'] = 'Установите стиль границы заголовков блоков';
$string['blockheadercolor'] = 'Цвет шрифта заголовка блока';
$string['blockheadercolordesc'] = 'Установите цвет шрифта заголовка блока';
...
$string['breadcrumbtitlefullname'] = 'Полное имя курса';
$string['breadcrumbtitleshortname'] = 'Краткое имя курса';
...
$string['frontpagelogin'] = 'Страница входа';
...
$string['headernavbarstylingheading'] = 'Стили меню навигации';
$string['headernavbarstylingheadingdesc'] = 'Параметры стилей для главного меню навигации';
...
$string['helptitle2'] = 'Вторая ссылка справки';
$string['hiddencourses'] = 'Скрытые курсы';
$string['hide'] = 'Скрыть';
$string['hidealertsmobile'] = 'Скрыть предупреждения (если используются) в мобильном виде';
$string['hidealertsmobiledesc'] = 'Выбор «Скрыть» убирает предупреждения на мобильных устройствах';
$string['hideblocks'] = 'Скрыть блоки';
$string['hidebreadcrumbmobile'] = 'Скрыть строку навигации в мобильном виде';
$string['hidebreadcrumbmobiledesc'] = 'Выбор этого параметра уберет строку навигации на мобильных устройствах';
$string['hidecoursetitlemobile'] = 'Скрыть название курса/сайта в мобильном виде';
$string['hidecoursetitlemobiledesc'] = 'Убирает название как курса, так и сайта на мобильных устройствах';
...
$string['hideheadermobile'] = 'Скрыть заголовок в мобильном виде';
$string['hideheadermobiledesc'] = 'Убирает заголовок с логотипом / значками социальных сетей / полем поиска на мобильных устройствах';
...
$string['hidelogomobile'] = 'Скрыть логотип в мобильном виде';
$string['hidelogomobiledesc'] = 'Убирает логотип на мобильных устройствах';
$string['hidepagefootermobile'] = 'Скрыть нижний колонтитул в мобильном виде';
$string['hidepagefootermobiledesc'] = 'Выбор данного параметра убирает нижний колонтитул на мобильных устройствах';
$string['hideslidermobile'] = 'Скрыть слайдер на мобильном телефоне';
$string['hidesocialmobile'] = 'Скрыть значки социальных сетей (если используются) в мобильном виде';
$string['hidesocialmobiledesc'] = 'Убирает значки социальных сетей на мобильных устройствах';
$string['home'] = 'Главная';
...
$string['mobilesettings'] = 'Настройки мобильного вида';
$string['mobilesettingsheading'] = 'Настройте вид вашего сайта на мобильных устройствах';
...
$string['settingsmenucolors'] = 'Цвета меню';
$string['settingsmessagescolors'] = 'Цвета всплывающих сообщений';
$string['settingsmobilemenucolors'] = 'Цвета мобильного меню';
...
$string['socialboxpaddingbottommobile'] = 'Установить отступ снизу для области соц.сетей на мобильном устройстве';
$string['socialboxpaddingtopmobile'] = 'Установить отступ сверху для области соц.сетей на мобильном устройстве';
...
$string['socialsizemobile'] = 'Размер шрифта значков социальных сетей в мобильном виде';
...
$string['tickertext1'] = 'Текст новостной ленты 1';
$string['tickertext1desc'] = 'Введите текст новости в данное поле (каждую новость - с новой строки!). В файле "read me" приведена более подробная информация.';
$string['tickertext2'] = 'Текст новостной ленты 2';
$string['tickertext2desc'] = 'Можно показывать разные новости разным людям, используя информацию из профиля пользователя.';
